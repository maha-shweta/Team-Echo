    ...
    <aside class="sidebar">
        ...
        <nav class="nav-menu">
            <?php if ($_SESSION['role'] == 'admin'): ?>
                ...
                <a href="../category/manage_category.php" class="nav-item">Categories</a>
        ...
        <main class="dashboard-content">
            ...
            <div class="page-header">
                ...
                <div style="display: flex; gap: 10px; align-items: center;">
                    ...
                    if ($_SESSION['role'] == 'admin') {
                        echo '<a href="../admin/admin_dashboard.php" class="btn-back">← Back to Dashboard</a>';
            ...
            <div style="background: white; padding: 20px; border-radius: 8px; margin-bottom: 20px; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.08);">
                <form class="filter-form" method="GET">
                    ...
                    <a href="ai_analytics_dashboard.php" class="reset-link"><i class="fa fa-redo"></i> Reset</a>
                </form>
            </div>
