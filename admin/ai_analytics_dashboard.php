...
<div class="main-layout">
    ...
    <aside class="sidebar">
        ...
        <nav class="nav-menu">
            ...
            <a href="<?php echo BASE_URL; ?>/admin/ai_analytics_dashboard.php" class="nav-item active">Team-Echo AI</a>
            <a href="<?php echo BASE_URL; ?>/feedback/export_feedback.php" class="nav-item">Export Feedback</a>
        </nav>
    </aside>
        ...
        <main class="dashboard-content">
            ...
            <div style="background: white; padding: 20px; border-radius: 8px; margin-bottom: 20px; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.08);">
                <form class="filter-form" method="GET">
                    ...
                    <a href="<?php echo BASE_URL; ?>/admin/ai_analytics_dashboard.php" class="reset-link"><i class="fa fa-redo"></i> Reset</a>
                </form>
            </div>
